...
## Corpus Check
- 365 files · ~2,501,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2742 nodes · 3557 edges · 164 communities detected
...
Cohesion: 0.01
Nodes (50): getFeatureEnabled(), getOidcEnabled(), getSignupEnabled(), openAuthPage(), openLoginForm(), openSignupForm(), signUp(), putBookSubResource() (+42 more)
...
Cohesion: 0.02
Nodes (27): scanAPIKey(), scanAuditLog(), toAuditLogDTO(), scanAuthor(), bookFileColumnsWithPrefix(), scanBookFile(), bookColumnsWithPrefix(), dollarN() (+19 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (29): isBookFilePathAllowed(), isPathUnderRoot(), finishBook(), finishEPUB(), finishMOBI(), hasProperty(), enqueuedJob, Enqueuer (+21 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (36): isSlogAny(), run(), AuthStore, AuthorStore, CrudStore, ExifToolOutput, GuideReference, Identifier (+28 more)
...
Cohesion: 0.04
Nodes (42): createGoodreadsMetadataFromResult(), enrichGoodreads(), lookupGoodreads(), NewEnrichGoodreadsHandler(), publishEvent(), publishProgress(), titleSimilar(), EnrichGoodreadsPayload (+34 more)
...
Cohesion: 0.15
Nodes (10): setupBookFileHandler(), TestDeleteBookFile_Handler(), TestDownloadBookFile_FileNotOnDisk(), TestDownloadBookFile_MethodNotAllowed(), TestDownloadBookFile_NotFound(), TestDownloadBookFile_PathForbidden(), TestDownloadBookFile_Success(), TestDownloadBookFile_UnknownSubResource() (+2 more)
...
Cohesion: 0.27
Nodes (2): OIDCHandler, generateState()
...
Cohesion: 0.36
Nodes (7): deleteResource(), deleteResourceCore(), deleteUserOwnedResource(), isNilValue(), listEntities(), listUserEntities(), mapSlice()
...
- **Thin community `Community 129`** (2 nodes): `vite.config.ts`, `restoreGitkeep()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (2 nodes): `test-setup.ts`, `createLocalStorageMock()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (2 nodes): `AlertBanner.test.ts`, `makeChildren()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (2 nodes): `Button.test.ts`, `makeChildren()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (2 nodes): `actions.ts`, `autofocusFirstButton()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (2 nodes): `client_test.go`, `TestNewClient()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (2 nodes): `analyzer_test.go`, `TestAnalyzer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (2 nodes): `bcrypt_helpers.go`, `mustGenerateDummyBcryptHash()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (2 nodes): `bcrypt_helpers_test.go`, `TestMustGenerateDummyBcryptHash()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (2 nodes): `rename_noreplace_linux.go`, `renameNoReplace()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (2 nodes): `rename_noreplace_other.go`, `renameNoReplace()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (2 nodes): `db_test.go`, `TestDialectOrderBy()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (2 nodes): `find_or_create.go`, `findOrCreate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (2 nodes): `testhelper_test.go`, `newTestDB()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (2 nodes): `tx.go`, `deferRollback()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (2 nodes): `decode.go`, `DecodeDataURL()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (2 nodes): `books_authors.go`, `setBookAuthorsRequest`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (2 nodes): `security_headers.go`, `SecurityHeadersMiddleware()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (2 nodes): `docs.go`, `init()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (1 nodes): `svelte.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `eslint.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `MyLibrary.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (1 nodes): `Sidebar.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (1 nodes): `TextInput.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (1 nodes): `UsersTab.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (1 nodes): `APIKeysTab.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (1 nodes): `KoboTab.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (1 nodes): `gen.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (1 nodes): `search.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (1 nodes): `fixtures.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (1 nodes): `frontend.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (1 nodes): `doc.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 161`** (1 nodes): `logger_keys.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (1 nodes): `book_queries.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 163`** (1 nodes): `kobo_cover.go`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `DB` connect `Community 2` to `Community 0`, `Community 8`, `Community 11`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `OPDSHandler` connect `Community 44` to `Community 0`?**
