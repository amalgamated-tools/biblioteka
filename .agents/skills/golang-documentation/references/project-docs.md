...
A copy-paste template with empty sections is available at [templates/README.md](../assets/templates/README.md).
...
Copy the template from [templates/CHANGELOG.md](../assets/templates/CHANGELOG.md).
