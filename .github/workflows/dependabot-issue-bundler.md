...
The bundle issues will have titles prefixed with `chore(deps): ` (added automatically by the safe-output). The body of the issue should contain a list of the relevant dependabot PRs with links to them, and any relevant information about the updates.
