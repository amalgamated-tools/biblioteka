...
// and returns monthly download counts for the authenticated user.
// Optional query parameter: months (default 12, max 24).
//
//	@Summary		Get downloads per month
//	@Description	Returns monthly download counts for the authenticated user.
//	@Tags			stats
//	@Security		BearerAuth
//	@Produce		json
//	@Param			months	query		int	false	"Number of months to return (default 12, max 24)"
//	@Success		200		{array}		monthlyDownloadsDTO
//	@Failure		401		{object}	errorResponse	"Unauthorized"
//	@Failure		405		{object}	errorResponse	"Method not allowed"
//	@Failure		500		{object}	errorResponse	"Internal server error"
//	@Router			/stats/downloads-per-month [get]
func (h *StatsHandler) HandleDownloadsPerMonth(w http.ResponseWriter, r *http.Request) {
	...
	months := parseQueryInt(r, "months", defaultStatMonths, maxStatMonths)
...
// and returns an annual reading summary for the authenticated user.
