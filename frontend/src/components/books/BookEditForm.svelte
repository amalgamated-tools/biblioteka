<script lang="ts">
  ...
  let {
    ...
    publisher = $bindable(""),
    language = $bindable(""),
    publicationDate = $bindable(""),
    isbn13 = $bindable(""),
    isbn10 = $bindable(""),
    asin = $bindable(""),
    goodreadsId = $bindable(""),
    hardcoverId = $bindable(""),
    googleBooksId = $bindable(""),
    coverImageUrl = $bindable(""),
    saving,
    formError,
    onsubmit,
    oncancel,
...
>
  ...
  <form {onsubmit} class="space-y-5">
    <p class="text-xs text-ink-500 dark:text-ink-300 mb-4">
