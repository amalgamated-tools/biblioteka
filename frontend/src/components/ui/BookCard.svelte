...
<div class="relative">
  <a
    href={`#books/${book.id}`}
    class="block bg-white dark:bg-ink-900 rounded-2xl shadow-sm border border-ink-100 dark:border-ink-800 overflow-hidden hover:shadow-md transition-shadow no-underline"
