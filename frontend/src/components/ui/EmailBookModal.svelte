<script lang="ts">
  ...
  const focusableSelector =
    'button:not([disabled]), a[href]:not([tabindex="-1"]), area[href]:not([tabindex="-1"]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';
        ...
        <form onsubmit={handleSubmit} class="space-y-4">
          {#if book.files.length > 1}
            <div>
              ...
              <select
                ...
                class="w-full px-4 py-2 border border-ink-400 dark:border-ink-400 rounded-xl bg-white dark:bg-ink-800 text-ink-900 dark:text-cream-100 focus:ring-2 focus:ring-accent-500 focus:border-transparent outline-none focus-visible:outline-none"
              >
          ...
          <div>
            ...
            <input
              ...
              required
              autocomplete="email"
              class="w-full px-4 py-2 border border-ink-400 dark:border-ink-400 rounded-xl bg-white dark:bg-ink-800 text-ink-900 dark:text-cream-100 focus:ring-2 focus:ring-accent-500 focus:border-transparent outline-none focus-visible:outline-none placeholder:text-ink-500 dark:placeholder:text-ink-300"
            />
          </div>
