...
<div>
    ...
    >
      <div class="flex items-start gap-5">
        ...
        <div>
          ...
          <p class="text-ink-400 dark:text-ink-300 mb-5 leading-relaxed">
  ...
  {:else}
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 stagger">
      ...
      >
        <p class="text-sm font-medium text-ink-400 dark:text-ink-300">
          Total Books
        </p>
        <p
    ...
    >
      ...
      <p class="text-ink-400 dark:text-ink-300 leading-relaxed">
