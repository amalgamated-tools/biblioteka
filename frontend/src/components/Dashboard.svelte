  ...
  {#if $librariesLoaded && $libraries.length === 0}
    <div class="bg-white dark:bg-ink-900 rounded-2xl p-8 shadow-sm border border-ink-100 dark:border-ink-800 animate-fade-in-up">
      <div class="flex items-start gap-5">
        ...
        <div>
          <h2 class="text-xl font-display font-bold text-ink-900 dark:text-cream-100 mb-2">Get started with Biblioteka</h2>
  ...
  {:else}
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 stagger">
      <div class="group bg-white dark:bg-ink-900 rounded-2xl p-6 shadow-sm border border-ink-100 dark:border-ink-800 hover:shadow-md hover:border-accent-200 dark:hover:border-accent-800/30 transition-all">
        <p class="text-sm font-medium text-ink-400 dark:text-ink-400">Total Books</p>
        <p class="text-4xl font-display font-bold text-ink-900 dark:text-cream-100 mt-2">0</p>
      </div>
      <div class="group bg-white dark:bg-ink-900 rounded-2xl p-6 shadow-sm border border-ink-100 dark:border-ink-800 hover:shadow-md hover:border-accent-200 dark:hover:border-accent-800/30 transition-all">
    ...
    <div class="mt-8 bg-white dark:bg-ink-900 rounded-2xl p-6 shadow-sm border border-ink-100 dark:border-ink-800 animate-fade-in">
      <h2 class="text-xl font-display font-bold text-ink-900 dark:text-cream-100 mb-3">Welcome to Biblioteka</h2>
