...
>
  ...
  <main class="w-full max-w-md relative z-10 animate-fade-in-up">
    <div class="text-center mb-8">
      ...
      <p class="text-ink-600 dark:text-ink-400 font-body">
      ...
      {#if oidcEnabled}
        ...
        <div class="relative mb-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span
              class="px-3 bg-white dark:bg-ink-900 text-ink-600 dark:text-ink-400"
              >or</span
            >
          </div>
        </div>
      ...
      <div role="tablist" aria-label="Authentication method" onkeydown={handleTabKeydown} class="flex gap-1 mb-6 bg-cream-100 dark:bg-ink-800 rounded-xl p-1">
        <button
          ...
          class="flex-1 py-2.5 px-4 rounded-lg font-medium transition-all {isLogin
            ...
            : 'text-ink-600 dark:text-ink-400 hover:text-ink-700 dark:hover:text-ink-200'}"
        >
          Login
        </button>
        <button
        ...
        <form onsubmit={handleSubmit} class="space-y-4">
          <div>
            ...
            <input
              ...
              bind:value={email}
              autocomplete="email"
              class="w-full px-4 py-3 rounded-xl border border-ink-200 dark:border-ink-700 bg-white dark:bg-ink-800 text-ink-900 dark:text-cream-100 focus:ring-2 focus:ring-accent-500 focus:border-transparent outline-none transition-all placeholder:text-ink-500 dark:placeholder:text-ink-500"
