...
Libraries represent named collections of books stored at one or more file-system paths. The background worker can index books found at those paths; the paths are validated to be existing directories on the server when creating or updating a library.
...
```json
{ "author_ids": ["a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4", "b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5"] }
```
...
{
  "entries": [
    { "series_id": "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4", "position": 1 }
  ]
}
```
...
{
  "id": "a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4",
  "book_id": "c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6",
  "file_type": "epub",
...
- **SQLite** (default): 32-character lowercase hex strings (e.g. `a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4`).
...
All `created_at` / `updated_at` fields are ISO 8601 UTC strings (e.g. `"2026-03-14T02:00:00Z"`).
