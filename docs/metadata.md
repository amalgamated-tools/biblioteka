...
> **Note:** A trailing `X` or `x` is accepted as a valid ISBN-10 check digit (the standard representation of check value 10). For example, `047596768X` is a valid ISBN-10.
