...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/books/capture": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "URL capture request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.captureRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.captureAcceptedResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "internal_handlers.captureAcceptedResponse": {
            "type": "object",
            "properties": {
                "library_id": {
                    "type": "string"
        ...
        "internal_handlers.captureRequest": {
            "type": "object",
            "properties": {
                "author": {
                    "type": "string"
