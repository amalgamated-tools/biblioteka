  ...
  src/
    ...
    components/         Page-level Svelte components (PascalCase)
      ...
      books/              Sub-components for book detail and editing
        ...
        BookDetail.svelte    Book detail view; displays cover image, metadata, author/series associations, file attachments, and download links; includes `AIEnrichmentPanel` in the detail view and reloads book data on apply via the panel's `onApplied` callback
