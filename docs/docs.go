...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/auth/oidc/link": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Link nonce from CreateLinkNonce",
                        "name": "nonce",
                        "in": "query",
                        "required": true
                    }
        ...
        "/kobo/tokens": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "Token data (required for POST)",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.koboTokenCreateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_handlers.koboTokenCreateRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
